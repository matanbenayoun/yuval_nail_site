...
export default function Gallery() {
  ...
  return (
    <section id="gallery" className="py-20 px-5" style={{ background: "oklch(0.96 0.008 65)" }}>
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-center text-xs text-muted-foreground mt-8">
          עקבי אחרינו{" "}
          <span className="underline underline-offset-4" style={{ color: "oklch(0.61 0.072 62)" }}>
            @yuval.nails
          </span>{" "}

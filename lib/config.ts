export const SITE_CONFIG = {
  ...
  subtitle: "ציפורניים",
  city: "באר שבע",
  address: "עבדת 15, שכונת נאות לון, באר שבע",
  phone: "050-393-3353",
  ...
  wazeUrl: "https://waze.com/ul?q=עבדת+15+נאות+לון+באר+שבע&navigate=yes",
  mapsUrl: "https://maps.google.com/?q=עבדת+15+נאות+לון+באר+שבע",
}
